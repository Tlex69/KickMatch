...
export default function LoadingScreen({ navigation }) {
  ...
  if (!isSuccess) {
    return (
      <View style={[styles.container, { paddingHorizontal: 20 }]}>
        ...
        <Text style={styles.loadingText}>กำลังตรวจสอบการสมัคร</Text>
  ...
  return (
    <View style={[styles.container, { paddingHorizontal: 20 }]}>
      ...
      <Text style={styles.successText}>สมัครสำเร็จ</Text>
      <Text style={styles.successSubText}>พร้อมจัดการแข่ง!</Text>

     <TouchableOpacity
  style={styles.button}
// จาก LoadingScreen
onPress={() => navigation.navigate("HomeO", { plan: "advanced" })}
>
  <Text style={styles.buttonText}>เข้าสู่โหมดฝ่ายจัด</Text>
</TouchableOpacity>
